<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CalendarioAdmin.aspx.cs" Inherits="Final_Herrera_Fernandez.CalendarioAdmin" %>
        ...
        <div class="row  ">
            ...
            <div class="col-12 d-flex justify-content-center">
                <div class="scrolling-table-container">
                    <asp:GridView ID="GVCalendario" runat="server" CssClass="table" BackColor="White" BorderColor="#99CCFF" CaptionAlign="Top" HorizontalAlign="Center" EmptyDataText="No hay eventos para este dia" GridLines="Vertical" Enabled="False">
